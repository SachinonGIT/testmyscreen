      ...
      <div className="relative container mx-auto px-6 py-24 z-10">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <p className="text-2xl sm:text-3xl leading-relaxed text-gray-200 font-light">
            ...
            >
              ...
              <Link
                href="/about"
                className="px-8 py-4 bg-gray-800 text-gray-300 rounded-xl font-medium 
        ...
        >
          {tests.map((test, index) => (
            ...
            >
              ...
              <Link href={test.href}>
                <div className="relative rounded-2xl p-8 bg-gray-800/80 backdrop-blur-sm border border-gray-700/50
                  ...
                  <div className="relative space-y-6">
                    <div className="flex items-center gap-4">
                      <motion.div
                        className="p-4 rounded-xl bg-gray-700/50 border border-gray-600/50 text-white
                      ...
                      <h2 className="text-2xl font-semibold text-white group-hover:text-blue-200 transition-colors duration-300">
                        {test.title}
                      </h2>
                    </div>
